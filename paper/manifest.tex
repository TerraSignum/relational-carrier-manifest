...
(coinciding with $(N_{\rm gen}d{+}1)/(d^{2}(d{+}1))$ at the
anchor $d{=}4, N_{\rm gen}{=}3$ via the algebraic identity
$2 N_{\rm gen}{-}1 = d{+}1$; the Cabibbo-class form
$(2 N_{\rm gen}{-}1)$ is canonical, derived in Paper~4). Both $d$
